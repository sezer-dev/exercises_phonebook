...
console.log('connction to', url);

mongoose.connect(url)
        .then(result => console.log('connected to MongoDB'))
        .catch(error => console.log('error connection to Mongoo DB:', error))
...
personSchema.set('toJSON',{ //Formatiere die erzeugte Json aus den Daten, so dass sie nicht __v anzeigt 
